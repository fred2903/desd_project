...
Regarding the setup time, the most critical path is located within the output selector (Path 21). While the design requirement demands a 150~MHz clock, this implementation achieves a positive slack of 0.230~ns. This safety margin allows the circuit to potentially operate at a maximum frequency of approximately 160~MHz.

Concerning the hold time, the critical path is identified within the \texttt{axis\_fifo\_0} module (Path 31). 
The required hold time constraint is 0~ns, and our implementation guarantees a safe positive hold slack of 0.230~ns, ensuring that no race conditions occur.
...
\begin{table}[H]
    ...
    \begin{minipage}[b]{0.50\textwidth}
        ...
        \begin{tabular}{lrcc}
            ...
            \midrule
            \textbf{Dynamic}   & \textbf{0.252} & \textbf{W} & \textbf{78\%} \\
